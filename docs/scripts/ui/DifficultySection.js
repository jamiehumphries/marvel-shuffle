import { difficulties } from "../data/cards.js?v=3c482674";
import { getItem, setItem } from "../data/storage.js?v=5a17bb47";
import { getNumberOfIncompleteGames } from "../data/tracker.js?v=c65f6100";
import { EXPERT, STANDARD } from "../models/Difficulty.js?v=108c7c44";
import { Section } from "./Section.js?v=1115d65e";
