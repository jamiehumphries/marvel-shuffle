import { difficulties } from "../data/cards.js?v=56cf2903";
import { getItem, setItem } from "../data/storage.js?v=5a17bb47";
import { getNumberOfIncompleteGames } from "../data/tracker.js?v=3d3dc210";
import { EXPERT, STANDARD } from "../models/Difficulty.js?v=134e77a0";
import { Section } from "./Section.js?v=52d33b87";
