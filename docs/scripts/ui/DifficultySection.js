import { difficulties } from "../data/cards.js?v=45e5e424";
import { getItem, setItem } from "../data/storage.js?v=5a17bb47";
import { getNumberOfIncompleteGames } from "../data/tracker.js?v=17ec1ba8";
import { EXPERT, STANDARD } from "../models/Difficulty.js?v=3260d64c";
import { Section } from "./Section.js?v=ed0b9c04";
