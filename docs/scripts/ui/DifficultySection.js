import { difficulties } from "../data/cards.js?v=f5618223";
import { getItem, setItem } from "../data/storage.js?v=5a17bb47";
import { getNumberOfIncompleteGames } from "../data/tracker.js?v=d835ab6d";
import { EXPERT, STANDARD } from "../models/Difficulty.js?v=49e65df3";
import { Section } from "./Section.js?v=fad74844";
