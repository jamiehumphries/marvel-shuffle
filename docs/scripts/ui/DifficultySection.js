import { difficulties } from "../data/cards.js?v=be21216e";
import { getItem, setItem } from "../data/storage.js?v=5a17bb47";
import { getNumberOfIncompleteGames } from "../data/tracker.js?v=af6efd5b";
import { EXPERT, STANDARD } from "../models/Difficulty.js?v=a17f456a";
import { Section } from "./Section.js?v=f4fc2dcf";
