import { difficulties } from "../data/cards.js?v=34086cf3";
import { getItem, setItem } from "../data/storage.js?v=5a17bb47";
import { getNumberOfIncompleteGames } from "../data/tracker.js?v=b39def15";
import { EXPERT, STANDARD } from "../models/Difficulty.js?v=fe5e6dba";
import { Section } from "./Section.js?v=f99ab316";
