import { difficulties } from "../data/cards.js?v=83bea52f";
import { getItem, setItem } from "../data/storage.js?v=5a17bb47";
import { getNumberOfIncompleteGames } from "../data/tracker.js?v=504f7005";
import { EXPERT, STANDARD } from "../models/Difficulty.js?v=88aaa6df";
import { Section } from "./Section.js?v=04ebee45";
