import { difficulties, extraModulars } from "../data/cards.js?v=aa9a1f37";
import { STANDARD } from "../models/Difficulty.js?v=f31a9937";
import { RadioSetting } from "../models/RadioSetting.js?v=1899c10b";
import { Setting } from "../models/Setting.js?v=ff1caa95";
